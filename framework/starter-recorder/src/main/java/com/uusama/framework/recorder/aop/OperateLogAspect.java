...
import static com.uusama.framework.api.constants.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        com.uusama.framework.recorder.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                                                                                              com.uusama.framework.recorder.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         com.uusama.framework.recorder.annotations.OperateLog operateLog) throws Throwable {
    ...
    private static void fillMethodFields(OperateLog operateLogObj,
        ...
        operateLogObj.setDuration((int) (DateTimeUtil.between(startTime, LocalDateTime.now(), ChronoUnit.MICROS)));
