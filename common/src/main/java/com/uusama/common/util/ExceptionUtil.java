...
public class ExceptionUtil {
    ...
    public static String getSimpleMessage(Throwable e) {
        return (null == e) ? StrPool.NULL : e.getMessage();
    }
    ...
    public static String stacktraceToOneLineString(Throwable throwable, int limit) {
        ...
        replaceCharToStrMap.put(CharPool.CR, StrUtil.SPACE);
        replaceCharToStrMap.put(CharPool.LF, StrUtil.SPACE);
        replaceCharToStrMap.put(CharPool.TAB, StrUtil.SPACE);
    ...
    public static String stacktraceToString(Throwable throwable, int limit, Map<Character, String> replaceCharToStrMap) {
        ...
        if (MapUtils.isNotEmpty(replaceCharToStrMap)) {
            ...
            return StrUtil.substring(exceptionStr, limit);
        }
    }
