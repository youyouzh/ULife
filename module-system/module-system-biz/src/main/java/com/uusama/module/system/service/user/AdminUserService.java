...
public interface AdminUserService {
     ...
     * @param state 状态
     */
    void updateUserStatus(Long id, CommonState state);
    ...
    default Map<Long, AdminUserDO> getUserMap(Collection<Long> ids) {
        ...
        return CollUtil.convertMap(getUserList(ids), AdminUserDO::getId);
    }
     ...
     * @return 用户们
     */
    List<AdminUserDO> getUserListByStatus(CommonState state);
