...
public interface RoleService {
     ...
     * @return 角色编号
     */
    Long createRole(@Valid RoleCreateReqVO reqVO, RoleTypeEnum type);
     ...
     * @param state 状态
     */
    void updateRoleStatus(Long id, CommonState state);
     ...
     */
    void updateRoleDataScope(Long id, DataScopeEnum dataScope, Set<Long> dataScopeDeptIds);
     ...
     * 获得角色列表
     *
     * @param states 筛选的状态。允许空，空时不筛选
     * @return 角色列表
     */
    List<RoleDO> getRoleListByStatus(@Nullable Collection<CommonState> states);
