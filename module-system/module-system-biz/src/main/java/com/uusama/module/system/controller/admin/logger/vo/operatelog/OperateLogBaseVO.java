...
public class OperateLogBaseVO {
    ...
    @Schema(description = "操作明细", example = "修改编号为 1 的用户信息，将性别从男改成女，将姓名从uusama改成源码。")
    ...
    @Schema(description = "Java 方法名", required = true, example = "cn.iocoder.uusama.adminserver.UserController.save(...)")
