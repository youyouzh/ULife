...
public interface OAuth2ApproveService {
     ...
     * @return 是否授权通过
     */
    boolean checkForPreApproval(Long userId, UserTypeEnum userType, String clientId, Collection<String> requestedScopes);
     ...
     * @return 是否授权通过
     */
    boolean updateAfterApproval(Long userId, UserTypeEnum userType, String clientId, Map<String, Boolean> requestedScopes);
     ...
     * @return 是否授权通过
     */
    List<OAuth2ApproveDO> getApproveList(Long userId, UserTypeEnum userType, String clientId);
