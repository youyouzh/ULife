...
public interface MenuService {
     ...
     * @param menuStates 菜单状态数组
     * @return 菜单列表
     */
    List<MenuDO> getMenuListFromCache(Collection<MenuTypeEnum> menuTypes, Collection<CommonState> menuStates);
     ...
     * @return 菜单数组
     */
    List<MenuDO> getMenuListFromCache(Collection<Long> menuIds, Collection<MenuTypeEnum> menuTypes,
