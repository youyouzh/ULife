...
import com.uusama.module.system.convert.oauth2.OAuth2OpenConvert;
...
import com.uusama.module.system.service.oauth2.OAuth2ApproveService;
import com.uusama.module.system.service.oauth2.OAuth2ClientService;
import com.uusama.module.system.service.oauth2.OAuth2GrantService;
import com.uusama.module.system.service.oauth2.OAuth2TokenService;
import com.uusama.module.system.util.OAuth2Utils;
...
public class OAuth2OpenController {
    ...
    private String[] obtainBasicAuthorization(HttpServletRequest request) {
        ...
        if (ArrayUtil.isEmpty(clientIdAndSecret) || Objects.requireNonNull(clientIdAndSecret).length != 2) {
